  ...
  for _, animationEvent in mergeData.MergedEvents do
   ...
   if ((mergeData.UnmergedEvents[x].EventType == animationEvent.EventType) and
    ...
    -- There is an effect name.
     ...
     if (animationEvent.Name ~= nil and MikSBT.CurrentProfile.ShowPartialEffects) then
...
function MikSBT.FormatEventText(animationEvent)
 ...
 if (animationEvent.MergeTrailerText ~= nil and MikSBT.CurrentProfile.ShowPartialEffects) then
...
function MikSBT.AddAnimation(animationEvent)
 ...
 if animationEvent.EffectName then
	--if MikSBT.counter2 == nil then MikSBT.counter2 = 0 end
	--MikSBT.counter2=MikSBT.counter2+1
	--print("proccs:"..MikSBT.counter2)
 ...
 elseif animationEvent.DamageType == "Physical" then
	texture = "Interface\\Icons\\Inv_sword_04"
	--if MikSBT.counter1 == nil then MikSBT.counter1 = 0 end
	--MikSBT.counter1=MikSBT.counter1+1
	--print("hits"..MikSBT.counter1)
 end
